...
public class Car extends Thread{
    ...
    public Car (boolean stop,Field field) {
        ...
        Point[][] paths = {
                ...
                {new Point(center + 2, 0), new Point(center + 2,center + 3), new Point(2 * center + 5,center + 3)},
        ...
        //field.setMainWindow(new MainWindow(gui_car));
    }
    ...
    public void run() {
        ...
        field.getMainWindow().drawPanel.arrayListcar.remove(this);
    }
}
